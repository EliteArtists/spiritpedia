  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[16/9] w-full overflow-hidden bg-black/40">
        ...
        {item.price && (
          <span className="absolute top-3 right-3 bg-[#f59e0b] text-[#78350f] text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full shadow-lg max-w-[70%] truncate">
            {item.price}
          </span>
        )}
      </div>
